...
public abstract class StringUtil {
	...
	public static String getPart2ByBlock(String target) {
        return getPart(target, ".\\s", 1);
    }
	
	public static String getPart2(String target, String seperator) {
        return getPart(target, seperator, 1);
    }
	
	public static String getPart(String target, String seperator, int indexNum) {
	    String[] split = target.split(seperator);
	    if (split.length > indexNum && indexNum > -1) {
	        return split[indexNum].trim();
	    }
	    return null;
	}
	
	public static String list2Str(List list, String connector) {
    ...
    public static String getformattedName(String name) {
        String[] split = name.split(Consts.REGEX_NOT_LETTER);
        String newName = "";
        if (split.length < 1) {
            return name;
        }
    ...
    /**
     * Just check that current str matches regex.
     *
     * <br/>
     * @param regex
     * @param str
